...
<div style="height: 50px; padding-top: 70px; width:auto; padding-left:50%; background: #F5F6F7; font-size: 18px; text-transform: uppercase;  border-bottom 2px solid #F2F2F2;  color: #515B6E; ">
 ...
 Fill the form below to register for free. Become a member.

</div>
<div style="width: 40%; display: inline-block; height: auto;">
...
function validateEmail(email){
     ...
     if (email == "") {
      ...
      var mess="Kindly enter a valid email Address";
      document.getElementById("d5").innerHTML = mess;
      ...
      else if (reg.test(email.value) == false) 
        {
          ...
          var mess="Invalid Email Address";
      document.getElementById("d5").innerHTML = mess;
...
function validateForm() {
    var x = document.forms["myForm"]["firstname"].value;//["lastname"]["idnumber"]["phonenumber"]["email"]["password"]["password2"]["company"]

var y= document.forms["myForm"]["lastname"].value;

var z= document.forms["myForm"]["idnumber"].value;
...
// var eml = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
    ...
    if (x == "") {
      ...
      var mess="Please enter your first name";
      document.getElementById("d1").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
...
var mess="";
    ...
    if (y == "") {
      ...
      var mess="Please enter your last name";
      document.getElementById("d2").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
   else
...
if (z == "") {
      ...
      var mess="Please enter a valid id number";
      document.getElementById("d3").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
else
...
if (a == "") {
      ...
      var mess="Enter phone number in shown format";
      document.getElementById("d4").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
else
...
if (c == "") {
      ...
      var mess="Password is required";
      document.getElementById("d6").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
else
...
if (d == "") {
      ...
      var mess="The password must match the one above.";
      document.getElementById("d7").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
else
...
if (e == "") {
      ...
      var mess="Comapny name is required";
      document.getElementById("d8").innerHTML = mess;
        //alert("Name must be filled out");
        return false;
    }
else
...
var mess="";
   ...
   <form method="POST" action="regaction.php" name="myForm"  onsubmit="return validateForm()">

   *All fields are mandatory<br><br>

  <div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">First Name:</label>
    <input type="text" class="form-control" name="firstname" placeholder="first name" required >

    <p style="color:red;"id="d1"></p>
  </div>
  <div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">Last Name:</label>
    <input type="text" class="form-control" name="lastname" placeholder="last name" required >
    <p style="color:red;"id="d2"></p>
  </div>
  <div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">Id Number:</label>
    <input type="tel" class="form-control" name="idnumber" placeholder="Enter a valid id number"  maxlength="8" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" glycon="pen" required >
    <p style="color:red;"id="d3"></p>
  </div>
  <div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">Phone Number:</label>
    <input type="tel" class="form-control" name="phonenumber" maxlength="13" pattern="[+][2][5][4][7][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" placeholder="phone number:+2547 xx xx xx xx" required >
    <p style="color:red;"id="d4"></p>
  </div>
  
<div class="form-group" >
    <label for="email"style="color:grey;" style="color:grey;">Email Address:<font style="color:red; font-size: 16px;">* </font></label>
    <input type="email" class="form-control" name="email" placeholder="email"onblur="validateEmail(this);" required>
    <p style="color:red;"id="d5"></p>
  </div>

<div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">User Name:</label>
    <input type="text" class="form-control" name="username" placeholder="username" required/  >
    <p style="color:red;"id="d2"></p>
  </div>

  <div class="form-group" >
    <label for="text"style="color:grey;" style="color:grey;">Password:</label>
    <input type="password" class="form-control" name="password" placeholder="password" required/ >
    <p style="color:red;"id="d6"></p>
  </div>
