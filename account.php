...
<li>
 ...
 <div style="height: 130px; padding-top: 70px; width:100%;  background: #F5F6F7; font-size: 18px;  text-align: center;  ">
...
<select name="category"  style="width: 20%; height: 30px;color: #515B6E; font-size: 15px; border-radius: 2px; border: 1px solid #45AEC1;box-shadow: inset 6px 6px 10px rgba(0, 0, 0, 0.1);  color:#45AEC1;  ">
...
<div style="height: auto; width: 96.4%; background: white; font-size: 24px;margin-left: 2%;   margin-bottom: 15px; color: #515B6E; font-weight: 600; padding-top: 20px;">
  Find Your Dream House.  Rent or Buy a House Within Kakamega
...
<div style="height: auto; width: 96.4%; background: white; font-size: 16px;margin-left: 2%;  border-bottom: 1px solid #F2F2F2; margin-bottom: 17px; color: #515B6E; font-weight: 300; padding-top: 10px; padding-bottom: 10px; ">
     Reserve your house now before it's taken
...
mysql_select_db("rentaldb") or die("database does not exist".mysql_error());
  ...
  define("NUMBER_PER_PAGE", 25); //number of records per page of the search results
...
$sql = "SELECT * FROM posts WHERE 1=1 AND username='lyn'";
...
<tr><td style='height:17px;'></td></tr>
       <tr><td style='color: #999; font-weight:300; font-size:16px;padding-left:15px;height:20px;'> Located in:&nbsp&nbsp" . $post['location'] . "</td></tr>
      ...
      <tr><td style='color: #999; font-weight:300; font-size:16px;padding-left:15px;height:20px;'> Cost:&nbsp&nbsp" . $post['cost'] . "</td></tr>
               ...
               <tr>
<td style='text-align:left; height:80px;padding-left:16px;'>
<a href='rentbuy.php? id=".$post['id']."'>
<button type='button' class='btn btn-success btn-xs' style='background:rgba(247, 74, 39, 0.8); width:auto; height:auto; border: 1px solid white; font-size:16px; border-radius:4px;' >
