...
<div style="height: auto; width: 96.4%; background: white; font-size: 21px;margin-left: 2%;  text-align: left; margin-bottom: 15px; color: #515B6E; font-weight: 600; padding-top: 20px;margin-bottom: 30px;">
  Cogratulation! Reservation succesfull. Here are the details of the house one more time: 
...
$username=$_SESSION['use'];
        ...
        $sql = "SELECT * FROM posts WHERE username='$username'  Limit 1 ";
...
<div style='height:400px; width:47%;  float:left; text-align:left;>
 ...
 <tr><td style='color: #999; font-weight:600; font-size:17px;padding-left:15px;height:30px;'>
...
<a href='cancelreservuser.php? id=".$row['id']."'   >
<button type='button' class='btn btn-success btn-xs' style='background:rgba(247, 74, 39, 0.9); width:auto; height:auto; border: 1px solid white; font-size:15px; border-radius:4px;' >
...
<tr><td style='font-size:20px; color: #515B6E;padding-left:15px;'>


Please Note:<br>

 We kindly urge you to make the payment within the next 6 hours; otherwise, the house will be available for grab by other people. 
</td>
