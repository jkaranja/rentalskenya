...
<div style="height: auto; width: 96.4%; background: white; font-size: 24px;margin-left: 2%;   margin-bottom: 15px; color: #515B6E; font-weight: 600; padding-top: 20px;">
  Find Your Dream House.  Buy a House Within Kakamega
...
$sql = "SELECT * FROM posts WHERE 1=1 AND username='lyn' AND category='Buy'";
...
<!--  <div style="height: auto; width: 96.4%; background: grey; font-size: 16px;margin-left: 2%;  border-bottom 1px solid #F2F2F2; margin-bottom: 15px; color: #515B6E; text-align: center; font-weight: 300; padding-top: 20px;">
