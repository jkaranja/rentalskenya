...
<td>" . $row['timeaction'] . "</td>


<td>

<a href='cancelreserv.php? id=".$row['id']."'   >
<button type='button' class='btn btn-success btn-xs' style='background:#008F4A; border: 1px solid #008F4A; ''>Cancel Reservation </button>

</a>
 </td>
 <td>

<a href='deletehouse.php? id=".$row['id']."'   >
<button type='button' class='btn btn-success btn-xs' style='background:#008F4A; border: 1px solid #008F4A; ''>Process complete!</button>
